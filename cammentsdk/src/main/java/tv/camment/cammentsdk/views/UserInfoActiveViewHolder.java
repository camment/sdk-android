...
final class UserInfoActiveViewHolder extends RecyclerView.ViewHolder {
    ...
    UserInfoActiveViewHolder(final View itemView, final UserInfoAdapter.ActionListener actionListener) {
        super(itemView);
