...
import tv.camment.cammentsdk.exoplayer.drm.DrmInitData;
...
import tv.camment.cammentsdk.exoplayer.mediacodec.MediaCodecInfo;
import tv.camment.cammentsdk.exoplayer.mediacodec.MediaCodecSelector;
import tv.camment.cammentsdk.exoplayer.mediacodec.MediaCodecUtil;
import tv.camment.cammentsdk.exoplayer.util.Assertions;
import tv.camment.cammentsdk.exoplayer.util.MimeTypes;
import tv.camment.cammentsdk.exoplayer.util.TraceUtil;
import tv.camment.cammentsdk.exoplayer.util.Util;
import tv.camment.cammentsdk.exoplayer.video.DummySurface;
import tv.camment.cammentsdk.exoplayer.video.VideoFrameReleaseTimeHelper;
import tv.camment.cammentsdk.exoplayer.video.VideoRendererEventListener;

public final class CMediaCodecVideoRenderer extends CMediaCodecRenderer {
    ...
    private CMediaCodecVideoRenderer.CodecMaxValues codecMaxValues;
    ...
    /* package */ CMediaCodecVideoRenderer.OnFrameRenderedListenerV23 tunnelingOnFrameRenderedListener;
     ...
     */
    public CMediaCodecVideoRenderer(Context context, MediaCodecSelector mediaCodecSelector) {
    ...
    protected void configureCodec(MediaCodecInfo codecInfo, MediaCodec codec, Format format,
        ...
        if (Util.SDK_INT >= 23 && tunneling) {
            tunnelingOnFrameRenderedListener = new CMediaCodecVideoRenderer.OnFrameRenderedListenerV23(codec);
        }
    }
    ...
    /**
     * Returns {@link CMediaCodecVideoRenderer.CodecMaxValues} suitable for configuring a codec for {@code format} in a way
     * that will allow possible adaptation to other compatible formats in {@code streamFormats}.
     *
     * @param codecInfo     Information about the {@link MediaCodec} being configured.
     * @param format        The format for which the codec is being configured.
     * @param streamFormats The possible stream formats.
     * @return Suitable {@link CMediaCodecVideoRenderer.CodecMaxValues}.
     * @throws MediaCodecUtil.DecoderQueryException If an error occurs querying {@code codecInfo}.
     */
    protected CMediaCodecVideoRenderer.CodecMaxValues getCodecMaxValues(MediaCodecInfo codecInfo, Format format,
        ...
        if (streamFormats.length == 1) {
            ...
            // being configured.
            return new CMediaCodecVideoRenderer.CodecMaxValues(maxWidth, maxHeight, maxInputSize);
        }
    ...
    protected MediaFormat getMediaFormat(Format format, CMediaCodecVideoRenderer.CodecMaxValues codecMaxValues,
    ...
    /**
     * Returns whether a codec with suitable {@link CMediaCodecVideoRenderer.CodecMaxValues} will support adaptation between
     * two {@link Format}s.
     *
