...
import tv.camment.cammentsdk.data.DataContract.UserGroupInfo;
...
public final class DataProvider extends ContentProvider {
    ...
    public void attachInfo(Context context, ProviderInfo info) {
        ...
        uriMatcher.addURI(AUTHORITY, Tables.USER_GROUP_INFO, Codes.USER_GROUP_INFO);
        uriMatcher.addURI(AUTHORITY, Tables.USER_GROUP_INFO_ID, Codes.USER_GROUP_INFO_ID);
    }
    ...
    public String getType(@NonNull Uri uri) {
        switch (uriMatcher.match(uri)) {
            ...
            case Codes.USER_GROUP_INFO:
                return UserGroupInfo.CONTENT_TYPE;
            case Codes.USER_GROUP_INFO_ID:
                return UserGroupInfo.CONTENT_TYPE_ITEM;
            default:
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case Codes.ADVERTISEMENT:
                ...
                break;
            case Codes.USER_GROUP_INFO:
                queryBuilder.setTables(Tables.USER_GROUP + " LEFT OUTER JOIN " + Tables.USER_INFO + " ON (" + Tables.USER_GROUP + "." + UserGroup.uuid + " = " + Tables.USER_INFO + "." + UserInfo.groupUuid + ")");
                break;
        }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        if (id > -1) {
            ...
            if (uriMatcher.match(uri) == Codes.USER_GROUP
                    || uriMatcher.match(uri) == Codes.USER_INFO) {
                getContext().getContentResolver().notifyChange(UserGroupInfo.CONTENT_URI, null);
            }
        }
        return uri;
    }
