...
public final class ExoPlayerLibraryInfo {
    ...
    /**
     * Whether the library was compiled with {@link tv.camment.cammentsdk.exoplayer.util.Assertions}
     * checks enabled.
     */
    public static final boolean ASSERTIONS_ENABLED = true;

    /**
     * Whether the library was compiled with {@link tv.camment.cammentsdk.exoplayer.util.TraceUtil}
     * trace enabled.
     */
