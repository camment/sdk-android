 ...
 */
package tv.camment.cammentsdk.exoplayer;
...
import tv.camment.cammentsdk.exoplayer.audio.AudioAttributes;
...
import tv.camment.cammentsdk.exoplayer.source.MediaSource;
import tv.camment.cammentsdk.exoplayer.source.TrackGroupArray;
import tv.camment.cammentsdk.exoplayer.text.Cue;
...
import tv.camment.cammentsdk.exoplayer.util.Clock;
...
public class SimpleExoPlayer implements ExoPlayer, Player.VideoComponent, Player.TextComponent {
     ...
     */
    @Deprecated
    public interface VideoListener extends tv.camment.cammentsdk.exoplayer.video.VideoListener {
    }
    ...
    private final CopyOnWriteArraySet<tv.camment.cammentsdk.exoplayer.video.VideoListener>
            videoListeners;
    ...
    @Override
    public void addVideoListener(tv.camment.cammentsdk.exoplayer.video.VideoListener listener) {
        videoListeners.add(listener);
    }

    @Override
    public void removeVideoListener(tv.camment.cammentsdk.exoplayer.video.VideoListener listener) {
     ...
     * @deprecated Use {@link #addVideoListener(tv.camment.cammentsdk.exoplayer.video.VideoListener)}.
     */
    @Deprecated
    ...
    /**
     * Equivalent to {@link #removeVideoListener(tv.camment.cammentsdk.exoplayer.video.VideoListener)}.
     *
     * @param listener The listener to clear.
     * @deprecated Use {@link
     * #removeVideoListener(tv.camment.cammentsdk.exoplayer.video.VideoListener)}.
     */
    @Deprecated
    ...
    private final class ComponentListener implements VideoRendererEventListener,
        ...
        public void onVideoSizeChanged(int width, int height, int unappliedRotationDegrees,
            ...
            for (tv.camment.cammentsdk.exoplayer.video.VideoListener videoListener : videoListeners) {
