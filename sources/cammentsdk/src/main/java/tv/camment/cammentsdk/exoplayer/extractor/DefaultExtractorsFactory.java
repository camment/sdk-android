 ...
 */
package tv.camment.cammentsdk.exoplayer.extractor;

import java.lang.reflect.Constructor;

import tv.camment.cammentsdk.exoplayer.extractor.flv.FlvExtractor;
import tv.camment.cammentsdk.exoplayer.extractor.mkv.MatroskaExtractor;
import tv.camment.cammentsdk.exoplayer.extractor.mp3.Mp3Extractor;
import tv.camment.cammentsdk.exoplayer.extractor.mp4.FragmentedMp4Extractor;
import tv.camment.cammentsdk.exoplayer.extractor.mp4.Mp4Extractor;
import tv.camment.cammentsdk.exoplayer.extractor.ogg.OggExtractor;
import tv.camment.cammentsdk.exoplayer.extractor.ts.Ac3Extractor;
import tv.camment.cammentsdk.exoplayer.extractor.ts.AdtsExtractor;
import tv.camment.cammentsdk.exoplayer.extractor.ts.DefaultTsPayloadReaderFactory;
import tv.camment.cammentsdk.exoplayer.extractor.ts.PsExtractor;
import tv.camment.cammentsdk.exoplayer.extractor.ts.TsExtractor;
import tv.camment.cammentsdk.exoplayer.extractor.ts.TsPayloadReader;
import tv.camment.cammentsdk.exoplayer.extractor.wav.WavExtractor;
import tv.camment.cammentsdk.exoplayer.util.TimestampAdjuster;
    ...
    static {
        ...
        try {
            ...
            flacExtractorConstructor =
                    Class.forName("tv.camment.cammentsdk.exoplayer.ext.flac.FlacExtractor")
